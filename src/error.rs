...
pub enum CustomError {
    ...
    #[error("{0}")]
    EmailConfirmationSandError(String),
    #[error("{0}")]
    EmailTokenNotFound(String),
    #[error("{0}")]
    EmailExpired(String),
    #[error("{0}")]
    EmailUsed(String),
...
impl ResponseError for CustomError {
    fn status_code(&self) -> actix_web::http::StatusCode {
        match self {
            ...
            CustomError::EmailConfirmationSandError(_) => actix_web::http::StatusCode::INTERNAL_SERVER_ERROR,
            ...
            CustomError::EmailUsed(_) => actix_web::http::StatusCode::CONFLICT,
            ...
            CustomError::EmailExpired(_) => actix_web::http::StatusCode::GONE,

            CustomError::EmailTokenNotFound(_) => actix_web::http::StatusCode::NOT_FOUND,
        }
    }
